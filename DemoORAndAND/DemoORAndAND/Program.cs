...
namespace DemoORAndAND
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            WriteLine("when the number of boxes is less than {0}", LOW_QUANTINITY);
            ...
            if ((deliveryZone == ZONE1 || deliveryZone == ZONE2) && quantity < LOW_QUANTINITY)
